...
class AuthClient(BaseClient):
    ...
    async def register(self, data: RegisterUserRequestSchema, **kwargs) -> APIResponseSchema[RegisterUserResponseSchema]:
    ...
    async def login(self, data: LoginUserRequestSchema, **kwargs) -> APIResponseSchema[LoginUserResponseSchema]:
        ...
        get_user_response_data = await self.__user_client.get_me(headers=self.get_auth_headers(response_data.access_token))
    ...
    def __create_session(
        ...
        login_data: LoginUserResponseSchema
    ) -> None:
