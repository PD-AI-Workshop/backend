...
def assert_update_by_id_response(
    response: APIResponseSchema[UpdateUserResponseSchema], request: UpdateUserRequestSchema
):
    assert_status_code(response.status_code, HTTPStatus.OK)
...
def assert_update_current_user_response(
    response: APIResponseSchema[UpdateUserResponseSchema], request: UpdateUserRequestSchema
):
